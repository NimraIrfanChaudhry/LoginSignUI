      ...
      body: Stack(
        children: [
          const Image(
              ...
              image: AssetImage('assets/images (8).jfif')),
          Container(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Spacer(),
                      GestureDetector( // Added GestureDetector for SignUp
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => Signup()), // Navigating to SignUpScreen
                          );
                        },
